...
def freeze_features_stats(data_json):
    ...
    if element in ['FRS_DEPTH', 'FRS_START', 'FRS_END', 'FRS_TIME','SNOW_DEPTH', 'SNOW_DAYS']:
        ...
        data_df = get_bingchuan_data(sta_ids, element_str, stats_times)
        refer_df = get_bingchuan_data(sta_ids, element_str, refer_years)
        nearly_df = get_bingchuan_data(sta_ids, element_str, nearly_years)
