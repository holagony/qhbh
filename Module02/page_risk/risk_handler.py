...
from Module02.page_risk.wrapped.station_processing import rain_change_processing
...
def risk_esti(data_json):
    ...
    ######################################################
    # 数据处理
    # 站点数据处理为年值的Rx5day和R20mm
    refer_df = rain_change_processing(refer_df)
    # print(refer_df.columns)
