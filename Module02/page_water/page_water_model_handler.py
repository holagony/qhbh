...
def water_model_def(data_json):
    ...
    # 评估数据_训练_验证
    train_evaluate,train_evaluate_station=water_evaluate_data_deal(train_time,hydro_ids,time_freq_main,time_freq_main_data)
...
if __name__=='__main__':
    ...
    data_json['train_time'] = '2023,2024'
    data_json['verify_time'] = '2023,2024'

    result=water_model_def(data_json)
